...
class ModifiedResNet(nn.Module):
    def __init__(self, input_channels: int, output_dim: int):
        ...
        self.fc = nn.Linear(512 * Bottleneck.expansion, output_dim)
...
class CLIP(nn.Module):
    def __init__(self,
                 ...
                 use_modified_resnet: bool = False,
                 normalize_images: bool = True
                 ):
        super().__init__()
        self.normalize_images = normalize_images
        if use_modified_resnet:
            self.visual = ModifiedResNet(input_channels=3, output_dim=embed_dim)
        else:
    ...
    #     logits_per_image = image1_features @ image2_features.t()
    ...
    def forward(self, image1, image2):
        ...
        similarity_scores = (image1_features @ image2_features.t()).diag()
